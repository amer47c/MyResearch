...
public class SmsSender implements SmsEventListener
{
    ...
    public SmsSender()
    {
        ...
        String smsUsername = "smsUsername@gmail.com";
        String smsPassword = "smsUsername";
        ...
        sms.setSender( "277663" ); // Set the sender number.
        sms.setMessage( "Hello World!" );
        sms.setRecipient( "9685245" ); // The recipients phone number.
